...
private struct CommandSearchResultRow: View {
  ...
  private var backgroundColor: Color {
    if isSelected {
      return CodingBuddyChatRuntimeStyle.panelBackground(for: colorScheme)
    } else if isHovered {
      return CodingBuddyChatRuntimeStyle.subtleCardBackground(for: colorScheme)
    }
    return Color.clear
  }
  ...
  private var commandIconView: some View {
    Image(systemName: "terminal")
      .font(.body)
      .foregroundStyle(CodingBuddyChatRuntimeStyle.secondaryText(for: colorScheme))
      .frame(width: 20)
  }
  ...
  private var scopeBadge: some View {
    ...
    .padding(.vertical, 2)
    .background(CodingBuddyChatRuntimeStyle.panelBackground(for: colorScheme), in: RoundedRectangle(cornerRadius: CodingBuddyChatRuntimeStyle.compactRadius))
    .foregroundStyle(CodingBuddyChatRuntimeStyle.secondaryText(for: colorScheme))
  }
