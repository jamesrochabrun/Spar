...
struct ToolDisplayView: View {
  ...
  private func contentView(for content: ToolDisplayFormatter.ToolContentFormatter) -> some View {
    ...
    .background(CodingBuddyChatRuntimeStyle.subtleCardBackground(for: colorScheme), in: RoundedRectangle(cornerRadius: CodingBuddyChatRuntimeStyle.compactRadius))
    .overlay {
