...
struct TableContentView: View {
  ...
  var body: some View {
    ...
    .clipShape(RoundedRectangle(cornerRadius: CodingBuddyChatRuntimeStyle.compactRadius))
    .overlay(
  ...
  private func rowBackground(for index: Int) -> Color {
    if index % 2 == 0 {
      ...
      return CodingBuddyChatRuntimeStyle.cardBackground(for: colorScheme)
    }
  }
...
struct TableCell: View {
  ...
  private var textColor: Color {
    if isHeader {
      ...
      return CodingBuddyChatRuntimeStyle.secondaryText(for: colorScheme)
    }
  }
