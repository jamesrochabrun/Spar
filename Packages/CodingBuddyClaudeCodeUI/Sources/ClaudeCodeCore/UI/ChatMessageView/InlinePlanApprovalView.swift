...
public struct InlinePlanApprovalView: View {
  ...
  public var body: some View {
          ...
          if showingDenyFeedback {
            ...
            VStack(alignment: .leading, spacing: 8) {
              ...
              TextEditor(text: $denyFeedback)
                ...
                .background(CodingBuddyChatRuntimeStyle.subtleCardBackground(for: colorScheme))
                .cornerRadius(CodingBuddyChatRuntimeStyle.compactRadius)
                .overlay(
                  RoundedRectangle(cornerRadius: CodingBuddyChatRuntimeStyle.compactRadius)
                    .stroke(CodingBuddyChatRuntimeStyle.border(for: colorScheme), lineWidth: 0.5)
                )
    ...
    .background(CodingBuddyChatRuntimeStyle.cardBackground(for: colorScheme))
    .cornerRadius(CodingBuddyChatRuntimeStyle.cardRadius)
    .overlay(
  ...
  private var headerColor: SwiftUI.Color {
    if isResolved {
      switch approvalStatus {
      case .approved, .approvedWithAutoAccept:
        return CodingBuddyChatRuntimeStyle.completedForeground(for: colorScheme)
      case .denied:
  ...
  private var actionButtonBackground: SwiftUI.Color {
    CodingBuddyChatRuntimeStyle.cardBackground(for: colorScheme)
  }
  ...
  private var borderColor: SwiftUI.Color {
    ...
    return CodingBuddyChatRuntimeStyle.border(for: colorScheme)
  }
